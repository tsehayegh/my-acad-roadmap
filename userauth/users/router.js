...
router.post('/api/users', jsonParser, (req, res) => {
  ...
  const stringFields = ['username', 'password', 'firstName', 'lastName', 'programcode'];
  ...
  let {username, password, firstName = '', lastName = '', programcode} = req.body;
